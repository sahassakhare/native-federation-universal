...
// Federation configuration for MFE1
const federationConfig = {
  name: 'mfe1',
  exposes: {
    './App': './src/App.js',
    './components/DynamicComponent': './src/components/DynamicComponent.js'
  },
  shared: {
...
// Build configuration
const buildConfig = {
  entryPoints: ['src/App.js', 'src/components/DynamicComponent.js'],
  bundle: true,
  outdir: 'dist',
  format: 'esm',
  splitting: true,
...
async function build() {
  try {
    console.log('Building MFE1 application...');
...
async function serve() {
  ...
  server.listen(4201, () => {
    console.log('MFE1 application running at http://localhost:4201');
  });
}
